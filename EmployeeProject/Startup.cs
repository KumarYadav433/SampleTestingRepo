...
using Miracle.Employee.Api.Repository.Repositories;
...
namespace EmployeeProject
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<SqlServerDBContext>(op => op.UseSqlServer(Configuration.GetConnectionString("empConn")));
